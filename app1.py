...
# ====== Model path ======
MODEL_PATH = r"C:\Users\Thavamani\Downloads\Car 24 Prediction\Project\Car_Price_Prediction.pkl"  # Fixed quote
...
if model is None:
    uploaded_file = st.file_uploader("Upload your trained model (.joblib/.pkl)", type=["joblib", "pkl"])
